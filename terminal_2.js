 ...
 5. Находясь в папке dir_1 создать пустой текстовый файл tf_1.txt: $ > tf_1.txt ;
...
$ find -name tf_4.txt
ответ терминала: ./inner_dir_1/tf_4.txt ;
...
$ tail -n4 inner_dir_1/tf_3.txt (обязательно пишем -n)
ответ терминала:
567
the second 2
the sec 2
...
$ find . -name "*.txt"| xargs grep -wl "sec"| xargs mv -t a_1

37. Команда в одну строку. Скопировать в любую одну папку текстовые файлы у которых в содержимом есть слово “sec”:

$ find . -name "*.txt"| xargs grep -wl "sec"| xargs cp -t .

38. Команда в одну строку. Найти все строки c “sec” во всех текстовых файлах, скопировать и вставить эти строки в один новый созданный текстовый файл:
$ grep -h sec $(find . -iname "*.txt") > a.txt

или 
find . -name "*.txt" | grep -rwl "sec" >> test.txt
      
 39. Команда в одну строку. Удалить текстовые файлы у которых в содержимом есть слово “sec”:
$ find -name "*.txt" | xargs grep -wl sec | xargs rm -r
